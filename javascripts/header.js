  ...
  function initializeHeader() {
    ...
    $("div.year_slider").slider({
      ...
      stop: function( event, ui ) {
        ...
        comparewindow.hide();
        var url = json_url + "/json/generated_data/graphs/"+deep+"/"+((name=="España")?'':name+'_')+normalization[compare]+"_"+year+".json";
        setValue(url);
    ...
    $('div.option_list ul li a').click(function(ev){
      ...
      if (!$(this).parent().hasClass('selected')) {
        ...
        if (state == 'mapa') {
          ...
          setValue("/json/generated_data/graphs/"+deep+"/"+((name=="España")?'':name+'_')+normalization[compare]+"_"+year+".json");
        }
